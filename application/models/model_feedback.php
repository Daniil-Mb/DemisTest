...
class Model_Feedback extends Model
{
    private $message = [
        ...
        'number' => 'Введите корректный номер, начинается с 8',
    ...
    {
        $stmt = $this->connect->prepare("INSERT INTO feedback (name, address, number, email) VALUES (?, ?, ?, ?)");
    ...
    {
        $result = $this->connect->query("SELECT * FROM feedback ORDER BY id DESC");
